...
The three squad members keep wider spacing during travel. After the significant
target is captured, one takes position ahead of the prisoner and two remain
behind for the return to camp rather than allowing the prisoner to trail the
Warden directly. The prisoner slows when necessary and cannot advance beyond
the forward guard.
